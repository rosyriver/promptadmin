...
import { Copy, MoreHorizontal, Play, Image, Video, Trash2, Pencil } from 'lucide-react';
...
export function PromptCaseCard({ c, onCopy, onClick, onMore, onDelete }: PromptCaseCardProps) {
  ...
  return (
    <div
      className="group relative bg-white rounded-[14px] border border-[#E4E4E7] hover:shadow-md hover:-translate-y-0.5 transition-all duration-200 cursor-pointer"
